...
@section('content')
    <div style="margin-bottom:50px;">
        <div class="row" style="text-align:center;height:300px;background-color:#424242;color:white;">
            @if ($post->image)
                <img src="{{url('images/'.$post->image)}}" class="img-responsive" alt="Responsive image">
            @endif
        </div>
        <div class="row" style="margin-top:-50px;">
            <div class="col-md-7 col-md-offset-1" style="background-color:white;padding:20px;">
                ...
                <p>{!!Markdown::convertToHtml($post->body)!!}</p>
            </div>
            <div class="col-md-3">
